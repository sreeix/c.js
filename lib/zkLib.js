...
module.exports = function (client, opts) {
    ...
    var l = {
        ...
        addSelfAndChildWatcher: function (path, options, onWatch) {
            return client.getDataAsync(path,onWatch).then(function () {
                return client.getChildrenAsync(path, function myWatcher(event) {
                    ...
                    if(event.name === 'NODE_DELETED' || event.name === 'NODE_DATA_CHANGED') {
                        ...
                        //     return onWatch(event);
                        // });
                        l.watchAllChildren(path, options, myWatcher).then(function (children) {
        ...
        watchAllChildren: function (path, options, onWatch) {
            ...
            return l.addSelfAndChildWatcher(path, options, onWatch).get(0).each(function (child) {
