...
module.exports = function (client, opts) {
    ...
    var l = {
        ...
        rmr: retryFn(function removeRecursive(path) {
            ...
            return client.existsAsync(path).then(function (stat) {
                if(stat) {
        ...
        addSelfAndChildWatcher: function (path, options, onWatch, x) {
            ...
            return l.getAndWatchNodeData(path, onWatch, root)
                .then(function () {
        ...
        watchAllChildren: function (path, options, onWatch) {
            ...
            return l.exists(path).then(function (stat) {
                return  stat ? l.addSelfAndChildWatcher(path, options, onWatch).tap(console.log): l.watchNonExistantNode(path, options, onWatch);
            });
